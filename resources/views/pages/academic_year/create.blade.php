...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Tambah Data Tahun Pembelajaran</h1>
    <a href="{{ route('tahun.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
